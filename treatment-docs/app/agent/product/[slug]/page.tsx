  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>{product.title} - Commerce API Reference</title>
            ...
            <section id="methods">
              ...
              <div className="method-block">
                <div className="method-signature">
                  <span className="keyword">def</span> <span className="func">session.cart.add</span>(<span className="param">variant_id</span>: <span className="string">str</span>, <span className="param">quantity</span>: <span className="string">int</span> = 1) -&gt; Cart
                </div>
